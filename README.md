...
Nếu `ask_codebase` vẫn timeout 300s trong client hiện tại, gần như chắc là MCP process cũ chưa restart. Chạy lại client hoặc restart MCP server, rồi gọi `goal_supervisor`/`list_tools` để xác nhận thấy 76 tools.
<!-- /harness-current-operations -->
